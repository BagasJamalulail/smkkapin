...
$tampil = mysqli_fetch_array(mysqli_query($koneksi,"SELECT * FROM soal WHERE id_soal='$id_soal'"));
...
if (isset($_POST['update_soal'])) {
  ...
  if ($foto!=="") {
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
      if($ukuran < 41144070){          
        $x_foto = $id_soal . '_' . $foto;
        move_uploaded_file($file_tmp, '../../kelas/img/'.$x_foto);
        $update_soal = mysqli_query($koneksi,"UPDATE soal SET soal='$soal', a='$a', b='$b', c='$c', d='$d', e='$e', knc_jawaban='$knc_jawaban', foto='$x_foto' WHERE id_soal='$id_soal'");
      }else{
                      ...
                      <div class="modal-content">
                       ...
                       <div class="modal-body">
                        <div class="form-group">
                          ...
                          <textarea name="soal" class="ckeditor" id="ckeditor"><?= $tampil['soal']; ?></textarea>
                        </div>
                        <div class="form-group">
                          <label class="form-control-label">Gambar (jika ada)</label>
                          <input type="file" name="foto" class="form-control">
                        </div>
                        <div class="form-group">
                          <label><b>Pilihan A</b></label>
                          <textarea name="a" class="ckeditor" id="ckeditor"><?= $tampil['a']; ?></textarea>
                        </div>
                        <div class="form-group">
                          <label><b>Pilihan B</b></label>
                          <textarea name="b" class="ckeditor" id="ckeditor"><?= $tampil['b']; ?></textarea>
                        </div>
                        <div class="form-group">
                          <label><b>Pilihan C</b></label>
                          <textarea name="c" class="ckeditor" id="ckeditor"><?= $tampil['c']; ?></textarea>
                        </div>
                        <div class="form-group">
                          <label><b>Pilihan D</b></label>
                          <textarea name="d" class="ckeditor" id="ckeditor"><?= $tampil['d']; ?></textarea>
                        </div>
                        <div class="form-group">
                          <label><b>Pilihan E</b></label>
                          <textarea name="e" class="ckeditor" id="ckeditor"><?= $tampil['e']; ?></textarea>
                        </div>
                        <div class="form-group">
                          <label><b>Kunci Jawaban</b></label>
                          <select name="knc_jawaban" class="form-control">
                            <option value="a" <?php echo ($tampil['knc_jawaban']=='a' OR $tampil['knc_jawaban']== 'A')?"selected":""; ?>>A 
                              <option value="b" <?php echo ($tampil['knc_jawaban']=='b' OR $tampil['knc_jawaban']== 'B')?"selected":""; ?>>B
                                <option value="c" <?php echo ($tampil['knc_jawaban']=='c' OR $tampil['knc_jawaban']== 'C')?"selected":""; ?>>C 
                                  <option value="d" <?php echo ($tampil['knc_jawaban']=='d' OR $tampil['knc_jawaban']== 'D')?"selected":""; ?>>D
                                    <option value="e" <?php echo ($tampil['knc_jawaban']=='e' OR $tampil['knc_jawaban']== 'E')?"selected":""; ?>>E  
                                    </select>
                                  </div>
                                </div>
                                <div class="modal-footer">
                                  <input type="submit" name="update_soal" class="btn btn-primary" value="Update">
                                </div>
                              </div>
                            </div>
                          </form>
